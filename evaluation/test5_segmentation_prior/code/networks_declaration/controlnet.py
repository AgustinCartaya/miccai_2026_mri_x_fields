        ...
        for i in range(len(channels) - 1):
            ...
            self.blocks.append(
                Convolution(
                    ...
                    # strides=2,
                    strides=1, # no hacer downsampling en el embedding de la segmentación porque ya se ha hecho un resize_center_crop_pad a la resolución final, así que el embedding ya tiene la resolución final y no es necesario hacer un downsampling adicional
                    kernel_size=3,
                    padding=1,
                    adn_ordering="A",
                    act="SWISH",
