...
def validation(
    ...
    for batch in tqdm(val_dataloader, desc="Validation"):
        for modality in args_train.modalities:
            ...
            complete_img = np.concatenate(subject_predictions_2D, axis=1)
...
args_train = {
    # directories 
    "output_path": "/home/agustin/phd/miccai/miccai_2026/mri_x_fields/experiments/test2_direct_dummy_conversion/training/models/test1",
    "checkpoints_dir_name": "check_points",
    "logs_dir_name": "logs",
    "val_imgs_dir_name": "val_imgs",

    # data
    "df_path": "/home/agustin/phd/miccai/miccai_2026/mri_x_fields/data/csv/train_data_with_latents_train_val.csv",
    ...
    # ---- pretrained_model
    # "load_pretrained_model_from": "/home/agustin/phd/synthesis/tests/D3/maisi/understanding_training/unconditioned_better_fixed/models/tests/pretrained_maisi_lr_scheduler/check_points/model_100000.pt",
