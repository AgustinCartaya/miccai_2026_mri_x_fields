        ...
        for subject_id in self.subject_ids:
            ...
            for modality in self.modalities:
                ...
                for resolution in self.resolutions:
                    ...
                    row = complete_df[
                        (complete_df["subject_id"] == subject_id)
...
def validation(
    ...
    for batch in tqdm(val_dataloader, desc="Validation"):
        for modality in args_train.modalities:
            ...
            complete_img.save(
                f"{imgs_2D_output_path}/step_{step}_{modality}_{batch['subject_id'][0]}.png"
            )
...
args_train = {
    # directories
    "output_path": "/home/agustin/phd/miccai/miccai_2026/mri_x_fields/experiments/test2_direct_dummy_conversion/training/models/to_3t/test1_t1W",
