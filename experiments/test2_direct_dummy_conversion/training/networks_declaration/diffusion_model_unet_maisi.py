...
# from tests.idea2_dummy_unet.networks_declaration.diffusion_model_unet import (
#     get_down_block,
#     get_mid_block,
...
class DiffusionModelUNetMaisi(nn.Module):
    ...
    def __init__(
        ...
        # JUST MODALITY EMBEDDINGS
        embed_dim =  num_channels[0] * 4
        new_time_embed_dim = embed_dim
        self.modality_embedding = self._create_embedding_module(nb_modalities, embed_dim)
    ...
    def _get_modality_embeddings(self, x, modality_tensor):
        return self.modality_embedding(modality_tensor).to(dtype=x.dtype)
    ...
    def forward(
        ...
        Args:
            ...
            modality_tensor: Tensor representing the modality (N, 4).
        ...
        # ADD MODALITY EMBEDDING
        emb = self._get_modality_embeddings(x, modality_tensor)
