...
args_train = {
    # directories
    "output_path": "/home/agustin/phd/miccai/miccai_2026/mri_x_fields/experiments/test7_my_own_net/training/models/singlemod/t1w/singlemod_gen01_disc01_test2",
    ...
    # ---- optimizer
    "lr_g": 1e-3,  # for maisi 1e-3 for maisi 1e-4 # for blsmd 2.5e-5
    "lr_d": 1e-3,  # for maisi 1e-3 for maisi 1e-4 # for blsmd 2.5e-5
    ...
    "loss_weights": {
        ...
        # "charbonnier": 1.0,
        # "ssim": 0.1,
        "recon_loss_weight": 0.001,  # weight for the reconstruction loss
