...
class PrepareDataset(Dataset):
    ...
    def load_pondered_segmentation(self, segmentation_npy_path, current_modality):
        seg_list = []
    ...
    def __getitem__(self, index):
        ...
        if self.use_pondered_segmentation:
            example["segmentation"] = self.load_pondered_segmentation(instance["segmentation_npy_path"], instance["modality"])
        else:
