        ...
        for batch in train_dataloader:
            ...
            with autocast("cuda", enabled=args_train.amp):
                ...
                if args_train.free_guidance_threshold is not None and args_train.free_guidance_threshold > 0:
                    ...
                    drop_mask = (
                        torch.rand(B, device=modality_embedding.device, generator=gen_free_guidance)
                        < args_train.free_guidance_threshold
                    )
...
args_train = {
    # directories
    "output_path": "/home/agustin/phd/miccai/miccai_2026/mri_x_fields/experiments/test5_segmentation_prior/training/models/all_357t/segconcatenated_synthsr/test2_merged3_4res_probseg_fgr",
    ...
    "load_pretrained_model_from": "/home/agustin/phd/miccai/miccai_2026/mri_x_fields/experiments/test5_segmentation_prior/training/models/all_357t/segconcatenated_synthsr/test1_merged3_4res_probseg/check_points/model_100000.pt",  
    # ---- resume from checkpoint
    ...
    "latent_synthsr_prob": 0.5,
    "free_guidance_threshold": 0.3
}
