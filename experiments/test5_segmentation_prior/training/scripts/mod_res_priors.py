...
def instantiate_unconditioned_models(device, noise_scheduler_type="rflow", nb_resolutions=5, nb_modalities=3):
    ...
    networks_config =  {
        ...
        "diffusion_unet_def": {
            ...
            "spatial_dims": 3,
            "in_channels": 4,  # 4 for the latent and nb_seg_classes for the segmentation conditioning (concatenated)
            "out_channels": 4,
            "num_res_blocks": 2,
            "num_channels": [
                # 32,
...
args_train = {
    # directories 
    "output_path": "/home/agustin/phd/miccai/miccai_2026/mri_x_fields/experiments/test5_segmentation_prior/training/models/all_357t/unconditionned/test1_4res",
