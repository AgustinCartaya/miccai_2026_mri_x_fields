...
class LoadPaths:
    ...
    def get_data(self, split="train", prefer_01t1w=False):
        ...
        for i, row in complete_df.iterrows():
            ...
            if prefer_01t1w and row["modality"] != "T1W":
                # verify if the T1W version of the latent_synthsr_path exists
                t1w_latent_synthsr_path = row["latent_synthsr_path"].replace(row["modality"], "T1W")
                if os.path.exists(t1w_latent_synthsr_path):
                    instance_dict["latent_synthsr_path"] = t1w_latent_synthsr_path
                    print(f"Using T1W version of latent_synthsr_path for subject {row['sid']} instead of {row['modality']}.")
...
class PrepareDataset(Dataset):
    def __init__(
        ...
        self.train_data = data_loader.get_data(split=split, prefer_01t1w=prefer_01t1w)
...
def train(
    ...
    train_dataloader = instantiate_dataset(
        ...
        prefer_01t1w=args_train.prefer_01t1w
...
args_train = {
    # directories
    "output_path": "/home/agustin/phd/miccai/miccai_2026/mri_x_fields/experiments/test5_segmentation_prior/training/models/all_357t/segconcatenated_synthsr/test2_merged3_4res_probseg_nofgr_combined_data_refined",
    ...
    "load_pretrained_model_from": "/home/agustin/phd/miccai/miccai_2026/mri_x_fields/experiments/test5_segmentation_prior/training/models/all_357t/segconcatenated_synthsr/test2_merged3_4res_probseg_nofgr_combined_data/check_points/model_280000.pt",
