    ...
    for epoch in range(first_epoch, max_epochs):
        for batch in train_dataloader:
            ...
            if (
                ...
                if (
                    args_train.initial_val
                    or global_step % args_train.val_interval == 0
                    or (global_step < 2500 and global_step % 500 == 0)
                ):
                    unet.eval()
...
args_train = {
    # directories
    "output_path": "/home/agustin/phd/miccai/miccai_2026/mri_x_fields/experiments/test5_segmentation_prior/training/models/all_357t/segconcatenated/test5_merged3_t1w_7T",
    ...
    "load_pretrained_model_from": "/home/agustin/phd/miccai/miccai_2026/mri_x_fields/experiments/test5_segmentation_prior/training/models/all_357t/segconcatenated/test5_merged3_t1w_7T/check_points/model_100000.pt",  # not working
    # ---- resume from checkpoint
    ...
    #         "S0821",
    #         "S0821",
    #     ]  # Example filter for a specific subject ID
    # },
    "val_train_dataset_filters": None,
    ...
    "used_pondered_segmentation": False,  # if True, the segmentation maps are pondered by the distance to the borders of the structures, if False, the segmentation maps are one hot encoded without pondering
}
