...
sys.path.append('/home/agustin/phd/miccai/miccai_2026/mri_x_fields/experiments/test3_unconditionned_diffusion_model/training/networks_declaration')
...
import  networks_declaration.conditions_model as conditions_embedder
...
def instantiate_unconditioned_models(device, noise_scheduler_type="rflow"):
    ...
    networks_config =  {
        ...
        "conditions_model_def": {
            # "_target_": "networks_declaration.conditions_model.ConditionEmbedding",
            "num_conditions": 3,
            "embed_dim": 256,
            "proj_hidden_dim": 128,
            "use_gelu": True,
            "dropout": 0.0 # Not necessary input will always be the same [T1, T2, FLAIR]
        },
  ...
  # class ConditionEmbedding(nn.Module):
    ...
    conditions_model = conditions_embedder.ConditionEmbedding(num_conditions = args.conditions_model_def.num_conditions,
                                                            embed_dim = args.conditions_model_def.embed_dim,
                                                            proj_hidden_dim = args.conditions_model_def.proj_hidden_dim,
                                                            use_gelu = args.conditions_model_def.use_gelu,
                                                            dropout = args.conditions_model_def.dropout
                                                            )
        ...
        for batch in train_dataloader:
            ...
            with autocast("cuda", enabled=args_train.amp):
                ...
                model_output = unet(noisy_latent, 
                                  timesteps=timesteps,
                                  context = condition_modality_emb,
                                    )
...
args_train = {
    # directories 
    "output_path": "/home/agustin/phd/miccai/miccai_2026/mri_x_fields/experiments/test3_unconditionned_diffusion_model/training/models/any_7t/test1",
    ...
    "used_modalities": ["T1W", "T2W", "T2FLAIR"], # "t1w", "t1c", "t2w", "t2f"
