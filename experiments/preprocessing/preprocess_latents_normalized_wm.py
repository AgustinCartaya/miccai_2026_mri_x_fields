...
def preprocess_latents(split="train"):
    ...
    for index, row in tqdm(df.iterrows(), total=df.shape[0]):
        ...
        img = prep_image.normalize_image_by_cerebral_wm_mean(img, wm_mask)
    ...
    df["latent_normalized_wm_path"] = latent_paths
    output_csv_path = f"/home/agustin/phd/miccai/miccai_2026/mri_x_fields/data/csv/{split}_data_with_latents_normalized_wm.csv"
