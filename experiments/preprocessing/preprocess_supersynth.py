...
def preprocess_supersynth(split="train", filter_modalities=None, filter_resolutions=None):
    ...
    # base_output_path = "/home/agustin/phd/miccai/miccai_2026/mri_x_fields/data/val_data/preprocessed/supersynth"
...
if __name__ == "__main__":
    ...
    preprocess_supersynth("pr_train", filter_modalities=None, filter_resolutions=None)