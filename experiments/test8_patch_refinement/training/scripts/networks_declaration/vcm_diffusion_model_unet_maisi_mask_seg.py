...
class VCMDiffusionModelUNetMaisi(nn.Module):
    """
    ...
    def __init__(
        ...
        time_embed_dim = 256 # hardcoded to 256, as in the original maisi implementation
    ...
    def forward(
        ...
        src_resolution_embedding: torch.Tensor | None = None,
    ) -> torch.Tensor:
        """
        Forward pass through the UNet model.

        Args:
            x: Input tensor of shape (N, C, SpatialDims) should contain the conditioning.
        ...
        if src_resolution_embedding is not None:
