...
def train(
    ...
    for epoch in range(first_epoch, max_epochs):
        for batch in train_dataloader:
            ...
            BZ, c, h, w, c = noisy_latent.size()
            lambda_1 = 1 / float((BZ * c * h * w * c))  # Normalizar la pérdida L1 por el tamaño del batch y las dimensiones de la imagen
...
args_train = {
    # directories
    "output_path": "/home/agustin/phd/miccai/miccai_2026/mri_x_fields/experiments/test8_patch_refinement/training/models/segconcatenated_synthsr_mod_res_prior_vcm/test2",
    ...
    # ---- optimizer
    "lr": 5e-5,  # for maisi 1e-3 for maisi 1e-4 # for blsmd 2.5e-5
